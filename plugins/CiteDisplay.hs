...
-- by default the citeKey.  The second element of the tuple is the display of the reference, and the
...
---addLink (d,c,r) = ([HtmlInline $ "<a name=\"" ++ CSL.citeId r ++ "\"></a>"] ++ d, c, r)
addLink (d,c,r) = ([($ "<a name=\"" ++ CSL.citeId r ++ "\"></a>")] ++ d, c, r)
